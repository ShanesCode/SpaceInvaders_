...
void TextManager::createText(const std::string& name, const std::string& fontName, int size, sf::Color color, std::string string, int xpos, int ypos) {
	sf::Text text;
...
void TextManager::updateTextPosition(const std::string& textName, int xpos, int ypos) {
	sf::Text text = getTextRef(textName);
	text.setPosition(xpos, ypos);
	texts[textName] = text;
}
