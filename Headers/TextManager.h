...
public:
	void createText(const std::string& name, const std::string& fontName, int size, sf::Color color, std::string string, int xpos, int ypos);
	...
	void updateTextPosition(const std::string& textName, int xpos, int ypos);
